          ...
          >
            <div className="bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] flex flex-col flex-1 items-center justify-between overflow-hidden rounded-[14px] w-full h-full p-4 sm:p-5">
              <div className="flex flex-col gap-4 items-center justify-between relative w-full h-full my-auto">
                ...
                <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[1.4] text-[14px] sm:text-[15px] lg:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Identify personal study habits, aesthetic preferences, and comforting cottagecore atmosphere elements</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] flex flex-col flex-1 items-center justify-between overflow-hidden rounded-[14px] w-full h-full p-4 sm:p-5">
              <div className="flex flex-col gap-4 items-center justify-between relative w-full h-full my-auto">
                ...
                <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[1.4] text-[14px] sm:text-[15px] lg:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Ideate warm earthy color schemes, foresty tones, and soothing timer interface layouts</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] flex flex-col flex-1 items-center justify-between overflow-hidden rounded-[14px] w-full h-full p-4 sm:p-5">
              <div className="flex flex-col gap-4 items-center justify-between relative w-full h-full my-auto">
                ...
                <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[1.4] text-[14px] sm:text-[15px] lg:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Hone frontend UI/UX design skills while translating cozy aesthetic ideas into interactive React components</p>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              <div className={`flex flex-col flex-1 items-center justify-between overflow-hidden rounded-[14px] w-full h-full p-4 sm:p-5 transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] ${isDevRevealed(0) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="flex flex-col gap-4 items-center justify-between relative w-full h-full my-auto">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[1.4] text-[14px] sm:text-[15px] lg:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Learned core React component lifecycles, hooks, and JavaScript state management fundamentals</p>
                </div>
              </div>
            </div>
            ...
            >
              <div className={`flex flex-col flex-1 items-center justify-between overflow-hidden rounded-[14px] w-full h-full p-4 sm:p-5 transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] ${isDevRevealed(1) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="flex flex-col gap-4 items-center justify-between relative w-full h-full my-auto">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[1.4] text-[14px] sm:text-[15px] lg:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Built custom timer interval countdown hooks and session switching logic</p>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              <div className={`flex flex-col flex-1 items-center justify-between overflow-hidden rounded-[14px] w-full h-full p-4 sm:p-5 transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] ${isDevRevealed(2) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="flex flex-col gap-4 items-center justify-between relative w-full h-full my-auto">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[1.4] text-[14px] sm:text-[15px] lg:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Honed design skills, crafting warm foresty color palettes and cozy cottagecore aesthetic details</p>
                </div>
              </div>
            </div>
            ...
            >
              <div className={`flex flex-col flex-1 items-center justify-between overflow-hidden rounded-[14px] w-full h-full p-4 sm:p-5 transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] ${isDevRevealed(3) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="flex flex-col gap-4 items-center justify-between relative w-full h-full my-auto">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[1.4] text-[14px] sm:text-[15px] lg:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Iterated based on personal usability testing and user feedback to ensure smooth performance</p>
                </div>
              </div>
            </div>
          </div>
