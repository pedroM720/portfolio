    ...
    <div className="bg-black w-full min-h-screen relative overflow-y-auto">
      ...
      <div className="bg-black content-stretch flex flex-col gap-[36px] lg:gap-[48px] items-center overflow-clip pb-[32px] pt-[36px] lg:pt-[64px] relative w-full">
        ...
        <div className="bg-transparent content-stretch flex flex-col lg:flex-row gap-6 lg:gap-[70px] items-center justify-center overflow-clip py-[10px] relative w-full px-4 max-w-[1200px] mx-auto">
          {/* DEFINE */}
          <div
            className={`relative p-[1px] rounded-[15px] bg-gradient-to-b from-[#534e4e] to-white shadow-[0px_0px_30px_2px_rgba(255,255,255,0.4)] h-auto min-h-[280px] lg:h-[320px] w-full max-w-[320px] lg:max-w-[280px] transition-all duration-500 cursor-pointer ${isRevealed(0) ? 'scale-105 opacity-100 z-30' : 'scale-95 opacity-50 z-10 blur-[1px]'}`}
          ...
          >
            <div className="bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] content-stretch flex flex-col items-start overflow-clip rounded-[15px] size-full p-4">
              <div className="content-stretch flex flex-col gap-[16px] min-h-[240px] items-center relative w-full pt-2">
                ...
                <p className="font-['JetBrains_Mono',sans-serif] font-normal h-auto leading-[normal] relative text-[15px] sm:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">define the problem through affinity mapping, user research, user interview, and personas</p>
              </div>
            </div>
          </div>
          ...
          {/* IDEATE */}
          <div
            className={`relative p-[1px] rounded-[15px] bg-gradient-to-b from-[#534e4e] to-white shadow-[0px_0px_30px_2px_rgba(255,255,255,0.4)] h-auto min-h-[280px] lg:h-[320px] w-full max-w-[320px] lg:max-w-[280px] transition-all duration-500 cursor-pointer ${isRevealed(1) ? 'scale-105 opacity-100 z-30' : 'scale-95 opacity-50 z-10 blur-[1px]'}`}
          ...
          >
            <div className="bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] content-stretch flex flex-col items-start overflow-clip rounded-[15px] size-full p-4">
              <div className="content-stretch flex flex-col gap-[16px] min-h-[240px] items-center relative w-full pt-2">
                ...
                <p className="font-['JetBrains_Mono',sans-serif] font-normal h-auto leading-[normal] relative text-[15px] sm:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Mind mapping, navigation and layout, visual style, Lo-Fi’s, brainstorming</p>
              </div>
            </div>
          </div>
          ...
          {/* DESIGN */}
          <div
            className={`relative p-[1px] rounded-[15px] bg-gradient-to-b from-[#534e4e] to-white shadow-[0px_0px_30px_2px_rgba(255,255,255,0.4)] h-auto min-h-[280px] lg:h-[320px] w-full max-w-[320px] lg:max-w-[280px] transition-all duration-500 cursor-pointer ${isRevealed(2) ? 'scale-105 opacity-100 z-30' : 'scale-95 opacity-50 z-10 blur-[1px]'}`}
          ...
          >
            <div className="bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] content-stretch flex flex-col items-start overflow-clip rounded-[15px] size-full p-4">
              <div className="content-stretch flex flex-col gap-[16px] min-h-[240px] items-center relative w-full pt-2">
                ...
                <p className="font-['JetBrains_Mono',sans-serif] font-normal h-auto leading-[normal] relative text-[15px] sm:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Mid-Fi’s, prototypes, wireframes, mockups, user testing, user feedback, and refinement</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-transparent relative w-full">
          <div className="flex flex-row items-center overflow-clip w-full max-w-[1200px] mx-auto">
            <div className="content-stretch flex items-center justify-center px-6 lg:px-[40px] py-[10px] relative w-full">
              <p className="font-['IBM_Plex_Mono',sans-serif] leading-[normal] not-italic relative shrink-0 text-[18px] sm:text-[24px] text-white tracking-[0.96px] max-w-[708px] text-center">{`For PlanWise the most crucial step was the definition problem as the app is primarily focused on solving the shortcomings of the current webapps that exist for scheduling group events `}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-transparent content-stretch flex flex-col gap-6 lg:gap-[70px] items-center justify-center overflow-clip p-[10px] relative w-full max-w-[1207px] mx-auto mb-[64px]">
          ...
          <div className="content-stretch flex flex-col lg:flex-row gap-6 lg:gap-[20px] items-center justify-center relative w-full px-4">
            {/* CONVERT */}
            <div
              className={`relative p-[1px] rounded-[15px] bg-gradient-to-b from-[#534e4e] to-white h-auto min-h-[280px] lg:h-[320px] w-full max-w-[320px] lg:max-w-[280px] cursor-pointer transition-all duration-500 ease-in-out ${isDevRevealed(0) ? 'scale-105 shadow-[0px_0px_30px_2px_rgba(255,255,255,0.4)] z-10' : 'scale-95 shadow-none z-0'}`}
              onClick={() => handleDevReveal(0)}
            >
              <div className={`content-stretch flex flex-col items-start overflow-clip rounded-[15px] size-full transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] p-4 ${isDevRevealed(0) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="content-stretch flex flex-col gap-[20px] items-center relative w-full pt-4">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[normal] relative text-[15px] sm:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Define the necessary framework, front-end tools, backend architecture, to realize the design</p>
                </div>
              </div>
            </div>
            ...
            {/* BACKEND */}
            <div
              className={`relative p-[1px] rounded-[15px] bg-gradient-to-b from-[#534e4e] to-white h-auto min-h-[280px] lg:h-[320px] w-full max-w-[320px] lg:max-w-[280px] cursor-pointer transition-all duration-500 ease-in-out ${isDevRevealed(1) ? 'scale-105 shadow-[0px_0px_30px_2px_rgba(255,255,255,0.4)] z-10' : 'scale-95 shadow-none z-0'}`}
              onClick={() => handleDevReveal(1)}
            >
              <div className={`content-stretch flex flex-col items-start overflow-clip rounded-[15px] size-full transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] p-4 ${isDevRevealed(1) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="content-stretch flex flex-col gap-[20px] items-center relative w-full pt-4">
                  <div className="relative w-full">
                    <div className="flex flex-row items-center justify-center size-full">
                      <div className="content-stretch flex items-center justify-center p-[5px] relative size-full gap-2">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[normal] relative text-[15px] sm:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Bootstrap a basic backend, setting up API endpoints, database connections, and functionality of the product</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="content-stretch flex flex-col lg:flex-row gap-6 lg:gap-[20px] items-center justify-center relative w-full px-4">
            {/* FRONTEND */}
            <div
              className={`relative p-[1px] rounded-[15px] bg-gradient-to-b from-[#534e4e] to-white h-auto min-h-[280px] lg:h-[320px] w-full max-w-[320px] lg:max-w-[280px] cursor-pointer transition-all duration-500 ease-in-out ${isDevRevealed(2) ? 'scale-105 shadow-[0px_0px_30px_2px_rgba(255,255,255,0.4)] z-10' : 'scale-95 shadow-none z-0'}`}
              onClick={() => handleDevReveal(2)}
            >
              <div className={`content-stretch flex flex-col items-start overflow-clip rounded-[15px] size-full transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] p-4 ${isDevRevealed(2) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="content-stretch flex flex-col gap-[20px] items-center relative w-full pt-4">
                  <div className="relative w-full">
                    <div className="flex flex-row items-center justify-center size-full">
                      <div className="content-stretch flex items-center justify-center p-[5px] relative size-full gap-2">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[normal] relative text-[15px] sm:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Build off backend to realize the frontend design using the right framework and tools, ideate and adapt the setup to achieve the goal</p>
                </div>
              </div>
            </div>
            ...
            {/* TEST */}
            <div
              className={`relative p-[1px] rounded-[15px] bg-gradient-to-b from-[#534e4e] to-white h-auto min-h-[280px] lg:h-[320px] w-full max-w-[320px] lg:max-w-[280px] cursor-pointer transition-all duration-500 ease-in-out ${isDevRevealed(3) ? 'scale-105 shadow-[0px_0px_30px_2px_rgba(255,255,255,0.4)] z-10' : 'scale-95 shadow-none z-0'}`}
              onClick={() => handleDevReveal(3)}
            >
              <div className={`content-stretch flex flex-col items-start overflow-clip rounded-[15px] size-full transition-all duration-500 bg-gradient-to-b from-[#161616] via-[63%] via-[#4c4848] to-[rgba(152,150,150,0.8)] p-4 ${isDevRevealed(3) ? 'blur-none brightness-100' : 'blur-[2px] brightness-50'}`}>
                <div className="content-stretch flex flex-col gap-[20px] items-center relative w-full pt-4">
                  <div className="relative w-full">
                    <div className="flex flex-row items-center justify-center size-full">
                      <div className="content-stretch flex items-center justify-center p-[5px] relative size-full gap-2">
                  ...
                  <p className="font-['JetBrains_Mono',sans-serif] font-normal leading-[normal] relative text-[15px] sm:text-[16px] text-center text-white tracking-[0.64px] w-full px-2">Test the product to iron out any bug or error, refine the code, and ensure the stability of the product, then refine and improve based off feedback</p>
                </div>
              </div>
            </div>
          </div>
