...
import planwiseImage from "../assets/planwise.png";
  ...
  return (
    <div className="absolute content-stretch flex gap-[36px] items-center left-[16px] top-[89px]">
      ...
      <div className="h-[796px] relative rounded-[15px] shrink-0 w-[378px]" data-name="image 17">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[15px] size-full" src={planwiseImage} />
      </div>
    </div>
  );
}
